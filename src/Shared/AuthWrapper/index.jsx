      ...
      <div className="h-full w-full flex items-center justify-center">
        ...
        <div className="flex flex-col items-center">
          <div className="text-center mx-auto space-y-4">
            ...
            />
            <h1 className="font-oswald font-bold text-[24px] sm:text-[28px] md:text-[32px] leading-[48px]">
              {headingText}
            </h1>
            <p className="font-oswald font-normal text-[18px] sm:text-[20px] leading-[24px]">
              {subHeading}
            </p>
          </div>
          ...
          {resetId &&
            <CustomBtn
              text="Continue"
              type="submit"
              className="w-full my-7 bg-[#2563EB] hover:bg-[#5c81d1] text-white"
            />
          }
        </div>
      </div>
